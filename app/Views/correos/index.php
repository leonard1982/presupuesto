...
<section class="email-workspace">
    <article class="card table-card">
        ...
        <div class="table-wrapper">
            <table class="table-professional js-data-table js-indexed-table" data-page-length="20" data-export-name="bandeja_correos" data-preference-key="correos_table_length">
                <thead>
                <tr>
                ...
                <?php else : ?>
                    <?php foreach ($emails as $emailRow) : ?>
                        ...
                        $selectUrl = correo_escape($baseUrl) . '/index.php?route=correos&uid=' . $rowUid;
                        ...
                        <tr class="<?php echo $isSelected ? 'email-row-selected' : ''; ?>">
                            ...
                            <td><?php echo correo_escape(isset($emailRow['snippet']) ? correo_substr($emailRow['snippet'], 140) : ''); ?></td>
                            <td>
    ...
    <article class="card">
        ...
        <?php if ($selectedEmailSafe === null) : ?>
            <p class="muted">Selecciona un correo de la lista para generar sugerencia y crear el movimiento con soporte.</p>
        <?php else : ?>
